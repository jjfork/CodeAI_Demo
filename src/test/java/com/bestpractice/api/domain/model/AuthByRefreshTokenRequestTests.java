...
public class AuthByRefreshTokenRequestTests {
    ...
    void testSetRefreshToken() {
        ...
        authByRefreshTokenRequest.setRefreshToken("someRefreshToken");
        // THEN - The refreshToken should be set to "someRefreshToken"
        assertEquals("someRefreshToken", authByRefreshTokenRequest.getRefreshToken());
    }
}
